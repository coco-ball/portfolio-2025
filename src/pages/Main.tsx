...
function Main() {
  return (
    <div className="h-screen overflow-scroll text-white mix-blend-exclusion pt-[4.5rem] px-10 text-4xl md:text-5xl">
      ...
      <div className="flex gap-6 mt-16 mb-40">
        <a
          ...
          className="border-4 rounded-full flex justify-center items-center w-16 h-16"
        >
          <img src="/images/mail.png" className="w-11 h-11" />
        </a>
        <a
          href="https://www.linkedin.com/in/chaewonyu"
          className="border-4 rounded-full flex justify-center items-center w-16 h-16 pl-[0.2rem]"
        >
          in
        </a>
      </div>
